...
class Homematic extends EventEmitter {
    constructor(ccuIP, homeyIP, logger) {
        super();
        this.logger = logger
        this.ccuIP = ccuIP;
    ...
    createConnections() {
        ...
        Object.keys(this.interfaceConfigs).forEach((interfaceName) => {
            self.connections[interfaceName] = new Connection(interfaceName, self.interfaceConfigs[interfaceName], self.logger)
    ...
    setValue(interface_name, address, key, value) {
